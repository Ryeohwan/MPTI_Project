...
const ManagerNavigation = () => {
    ...
    return (
        ...
        <Link  to={"./approval"}> <li onClick={()=> setChoice("sign")} className={styles.nav_sign}><span style={choice==="sign"? {visibility:"visible"}:null} className={styles.select_square1} >&#9654;</span>가입승인</li></Link>
