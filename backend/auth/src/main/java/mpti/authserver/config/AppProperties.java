...
public class AppProperties {
    ...
    public static class Auth {
        ...
        private String trainerServerUrl;
        ...
        public String getTrainerServerUrl() {
            return trainerServerUrl;
        }

        public void setTrainerServerUrl(String trainerServerUrl) {
            this.trainerServerUrl = trainerServerUrl;
        }
